...
exports.areChildrenVisible = function (quest) {
...
exports.getAnswers = function (form) {
    var answers = {};
    var helper = function (quest) {
        if (quest.answer) {
            answers[quest.title] = quest.answer;
        }
        if (exports.areChildrenVisible(quest)) {
...
exports.isFormComplete = function (form) {
    var helper = function (quest) {
        if (quest.isRequired && !quest.answer) {
            return false;
        }
        if (quest.children && exports.areChildrenVisible(quest)) {
